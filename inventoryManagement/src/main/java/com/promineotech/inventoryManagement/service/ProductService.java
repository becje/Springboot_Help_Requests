...
public class ProductService {
	...
	private static final Logger logger = (Logger) LogManager.getLogger(ProductService.class);
	...
	public void removeProduct(Long id) throws Exception {
		try {
			...
			logger.error("Exceptioin occured while trying to delete product: " + id, e);
